...
use axum_sessions_auth::{AuthSession, AuthSessionLayer, AxumAuthConfig, Auth, Rights};
use tower_http::trace::TraceLayer;
use tracing_subscriber::{layer::SubscriberExt,util::SubscriberInitExt};

use meli_backend::{*, axum_pg_pool::AxumPgPool, models::User, util::get_connection, handlers::*};
use uuid::Uuid;
...
//     let mut conn = util::get_connection();
