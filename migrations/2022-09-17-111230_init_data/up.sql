...
INSERT INTO permissions (permission_id,permission_code,permission_name,description,enabled,create_time,update_time,data) VALUES(uuid_generate_v4(),'BarberBase','商户用户普通权限','普通理发师可以使用的权限',true,now(),now(),null);
INSERT INTO permissions (permission_id,permission_code,permission_name,description,enabled,create_time,update_time,data) VALUES(uuid_generate_v4(),'MemberBase','顾客普通权限','顾客普通权限',true,now(),now(),null);
